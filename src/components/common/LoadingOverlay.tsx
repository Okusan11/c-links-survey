  ...
  return (
    ...
    >
      <div className="relative bg-white/95 backdrop-blur-xl border border-white/20 shadow-2xl rounded-2xl p-8 max-w-md w-full mx-4 sm:mx-0 text-center overflow-hidden animate-in slide-in-from-bottom-4 duration-500">
        ...
        {/* 上部のフローティングアクセント */}
        <div className="absolute -top-1 left-1/2 transform -translate-x-1/2 w-16 h-1 bg-gradient-to-r from-primary via-accent to-primary rounded-full"></div>
        ...
        <div className="relative flex flex-col items-center">
          ...
          <div className="relative mb-8">
            ...
            <div className="absolute inset-2 rounded-full bg-gradient-to-r from-primary/20 to-accent/20 animate-pulse delay-75"></div>
            ...
            <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-2 h-2">
              <div className="w-full h-full bg-gradient-to-r from-primary to-accent rounded-full opacity-0 animate-ping delay-150"></div>
            </div>
          </div>
          ...
          {/* 下部の装飾バー */}
          <div className="mt-6 w-24 h-0.5 bg-gradient-to-r from-transparent via-primary/50 to-transparent"></div>
        </div>
        
        {/* 右下の装飾要素 */}
        <div className="absolute -bottom-2 -right-2 w-12 h-12 bg-gradient-to-br from-primary/10 to-accent/10 rounded-full blur-xl"></div>
        
        {/* 左上の装飾要素 */}
        <div className="absolute -top-2 -left-2 w-8 h-8 bg-gradient-to-br from-accent/10 to-primary/10 rounded-full blur-lg"></div>
      </div>
      
      {/* 背景のアニメーション要素 */}
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className="absolute top-1/4 left-1/4 w-32 h-32 bg-primary/5 rounded-full blur-3xl animate-pulse delay-300"></div>
        <div className="absolute bottom-1/4 right-1/4 w-24 h-24 bg-accent/5 rounded-full blur-2xl animate-pulse delay-700"></div>
        <div className="absolute top-3/4 left-3/4 w-16 h-16 bg-secondary/10 rounded-full blur-xl animate-pulse delay-1000"></div>
      </div>
    </div>
  );
};
