...
interface RepeaterQuestionsProps {
...
const RepeaterQuestions: React.FC<RepeaterQuestionsProps> = ({
  surveyConfig,
  satisfaction,
  setSatisfaction,
  otherSatisfaction,
    ...
    <>
      ...
      <QuestionBox data-question="satisfaction">
        <div className="space-y-8">
          ...
          {surveyConfig.repeaterOptions.satisfactionOptions.includes('その他') && satisfaction === 'その他' && (
...
export default RepeaterQuestions;